...
class Calculator:
    def __init__(self,master):
        ...
        Button(width=11,height=4.text='%',relief='flat',bg='white',command=lambda:self.show('%').place(x=100 ,y=50))
        ...
        Button(width=11,height=4.text='3',relief='flat',bg='white',command=lambda:self.show('3').place(x=100 ,y=125))
        Button(width=11,height=4.text='4',relief='flat',bg='white',command=lambda:self.show('4').place(x=0 ,y=200))
        Button(width=11,height=4.text='5',relief='flat',bg='white',command=lambda:self.show('5').place(x=90 ,y=200))
        Button(width=11,height=4.text='6',relief='flat',bg='white',command=lambda:self.show('6').place(x=100 ,y=200))
        ...
        Button(width=11,height=4.text='0',relief='flat',bg='white',command=lambda:self.show('0').place(x=100 ,y=350))
        ...
        Button(width=11,height=4.text='=',relief='flat',bg='white',command=lambda:self.show('').place(x= ,y=))
        Button(width=11,height=4.text='C',relief='flat',bg='white',command=lambda:self.show('').place(x= ,y=))
